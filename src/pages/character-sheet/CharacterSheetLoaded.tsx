  ...
  return (
    <>
      ...
      <Layout
        ...
        title={
          <input
            className="w-full min-w-0 truncate bg-transparent text-2xl font-bold outline-none placeholder:text-muted focus:border-b focus:border-gold/40"
        ...
        actions={
          <>
            ...
            <LinkButton to="/" variant="default" className="px-2.5 py-1.5 text-sm">
              Volver
            </LinkButton>
          </>
        }
        ...
        <div className="pb-16 lg:pb-4">
          ...
          {pdfDisponible === false && !errorPdf && (
            <p className="mb-3 rounded-lg border border-white/10 bg-surface/50 px-3 py-2 text-xs text-muted">
              ...
              <code className="text-white/80">public/pdf/pj2024-template.pdf</code>. Ejecuta{" "}
              <code className="text-white/80">npm run prepare:pdf-template</code>.
            </p>
          )}
